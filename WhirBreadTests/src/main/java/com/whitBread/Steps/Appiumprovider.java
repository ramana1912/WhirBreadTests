	...
	public static AppiumDriver<MobileElement> getDriver(){
	 ...
	 @Before
	    public void setUp() throws IOException
	    {
	        ...
	        desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE,"com.support.android.designlibdemo");
	        desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY,"com.support.android.designlibdemo.MainActivity");
